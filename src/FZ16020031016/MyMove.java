...
//        走这里比较好的step
//        ArrayList<int[]> shouldgo = new ArrayList<int[]>();
...
//        for (Step s: allStep){
//            System.out.println("=============================");
//            System.out.println(str1.charAt(s.getFirstStep() % 19));
//            System.out.println(str1.charAt((int)Math.floor(s.getFirstStep() / 19.0))  );
//            System.out.println(str1.charAt(s.getSecondStep() % 19));
//            System.out.println(str1.charAt((int)Math.floor(s.getSecondStep() / 19.0))  );
//            System.out.println("=============================");
//        }
    }
...
//        this.randomStep(board);
        ...
        for (int i = 0 ; i < 19;i++){
            for(int j = 0;j<19;j++){
                ...
                //这个点必须要堵的时候加入，--或者比对于自己的优势分更大的时候加入
